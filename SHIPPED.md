...
| 003 | 2026-08-05 | codeowners | Paste a CODEOWNERS file and the paths a PR touches — which rule wins, who gets requested, which lines GitHub skips | **FAIL** (2 independent checkers; one fix cycle spent; targeted re-check failed) | not shipped |
